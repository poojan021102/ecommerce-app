        ...
        <div>
            <div className="cotainer-fluid">
                <div className="row d-flex align-items-center justify-content-center">
                    <div className="col-md-6 pt-5 pb-5 col-sm-6 col-xs-12 d-flex align-items-center justify-content-start">
                        <img className='border-0' src={loginPageImage} style={{height:'50%',width:'70%'}} alt="Login" />
                    </div>
                    <div className="col-md-6 col-sm-6 col-xs-12 d-flex justify-content-start align-items-center">
